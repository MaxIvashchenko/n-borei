...
export default function Header({ mainPage }) {
    ...
    return (
        <>
            <div style={{ position: "absolute", top: 25, padding: "0px 5px", zIndex: 999 }}>
                <Button style={{ color: "rgba(0,0,0,.5)", margin: 0 }} onClick={() => i18n.changeLanguage('ru')} variant="link">ru</Button>
                <Button style={{ color: "rgba(0,0,0,.5)", padding: 0 }} onClick={() => i18n.changeLanguage('en')} variant="link">en</Button>
            </div>
